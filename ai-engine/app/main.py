...
def rca(body: Analysis = Body(...)): return score(body.topology,body.telemetry)
@app.post('/predict/failure')
def failure(body: Prediction = Body(...)): return predict(body.services)
@app.post('/simulate/counterfactual')
def counterfactual(body: Simulation = Body(...)): return simulate(body.topology,body.services,body.target,body.reductionPercent)
